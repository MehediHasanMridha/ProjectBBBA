...
@section('bsmrstu_logo')
    <div
        ...
        <img class="w-[0px] lg:w-[120px] lg:mx-3" src="{{ asset('images/logo.jpg') }}" alt="" />
    </div>
@endsection
    ...
    <div class="absolute top-[100px] left-1/2 flex -translate-x-1/2 transform flex-col space-y-[15px] text-center lg:relative lg:top-0 lg:left-0 lg:mt-[12px] lg:-translate-x-0">
        ...
        <div class="text font-['Segoe UI'] btn mx-auto font-bold text-[#3E3E3E] lg:w-[130px] lg:text-[39px]">
            ...
            <div class="mx-auto w-[374px]">
                <input class="bg-[#3E3E3E] px-3 text-white focus:outline-none lg:h-[45px] lg:w-[374px] lg:text-lg"
            ...
            <div class="loginBtn font-[Segoe UI] mx-auto w-[190px] cursor-pointer rounded-full bg-[#006666] p-2 text-center font-semibold text-white hover:bg-[#1AA2A2] lg:text-[30px]">
                <input type="submit" class="cursor-pointer" value="Continue">
